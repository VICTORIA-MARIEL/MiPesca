...
public class RecuperarUsuarioActivity extends AppCompatActivity {
    ...
    private static final String TAG = "RecuperarUsuarioAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usuarioId = intentFrom.getIntExtra("usuarioId",0);
        ...
        txtMunicipio.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                ArrayAdapter<String> adapter3 = new ArrayAdapter<String>
                        (RecuperarUsuarioActivity.this, android.R.layout.select_dialog_item, listaComunidades);
        ...
        txtComunidad.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                ArrayAdapter<String> adapter3 = new ArrayAdapter<String>
                        (RecuperarUsuarioActivity.this, android.R.layout.select_dialog_item, listaCooperativas);
        ...
        iconFhNacimiento.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        DatePickerDialog dialog = new DatePickerDialog(RecuperarUsuarioActivity.this, mDateSetListener, year, month, day);
        ...
        btnRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(exito) {
                    ...
                    Toast.makeText(RecuperarUsuarioActivity.this, "Error 100: Captura erronea de un dato.", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void llenarCampos(){
        if(usuario!=null) {
            ...
            txtConfirmarContrasena.setText(usuario.getUsuarioContrasena());
        }
...
//            iconCambioComunidad.setVisibility(View.VISIBLE);
    ...
    private boolean validarCampos(){
        ...
        */
        ...
        if(exito) {
            ...
            pescadorEntity.setPescadorUsrRegistro(usuarioId);
    ...
    private void goToConfirmacion(int usuarioId, int pescadorId, String claveConfirmacion){
        Intent intent = new Intent(RecuperarUsuarioActivity.this, ConfirmarRegistroActivity.class);
        intent.putExtra("pescadorId",pescadorId);
        intent.putExtra("usuarioId",usuarioId);
        intent.putExtra("cve",claveConfirmacion);
        intent.putExtra("movto","actualizar");
        startActivity(intent);
    }

    private void goToLogin(){
        Intent intent = new Intent(RecuperarUsuarioActivity.this, LoginActivity.class);
